...
def build_review_prompt(
    ...
    return (
        "You are a conservative clinical safety reviewer for a short-form parent education video.\n"
        ...
        '  "accuracy_score": 1,\n'
        '  "language_integrity_score": 1,\n'
        '  "video_script_match_score": 1,\n'
        '  "observed_visuals_ko": "",\n'
        '  "summary_ko": "",\n'
        ...
        "  ]\n"
        "}\n"
        "Use scores from 1 to 5. Use 5 for publishable with no meaningful medical issue, "
...
def review_output_dir(output_dir: Path, model: str, visual_input: str) -> Dict[str, Any]:
    ...
    review = gemini_json(
        ...
        [
            uploaded_visual,
            build_review_prompt(script, captions, video_path, visual_basis, contact_sheet_path),
        ],
    )
